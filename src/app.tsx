...
import { queryCurrentUser, logout, queryCurrentUserMenus } from './services/swagger/user';
...
const Wrapper: FC<PropsWithChildren> = ({ children }) => {
  useEffect(() => {
    const backup = history.replace;
    // rewrite history
    history.push = (path: any, state: any) => {
      if (window.__MICRO_APP_ENVIRONMENT__) {
        const _history = window.microApp.getData().history;
