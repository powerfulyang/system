 ...
 */
export const EditRoleModalAtom = atom<number | undefined>(undefined);
...
export const EditRoleModal: FC<Props> = ({ onOk }) => {
  ...
  const mutation = useMutation({
    mutationFn(values: API.CreateRoleDto) {
      if ('id' in values) {
    ...
    >
      <Spin spinning={isFetching}>
        ...
        >
          ...
          />
          <ProFormCheckbox.Group label="permissions" name="permissions" request={listPermissions} />
        </ProForm>
      </Spin>
    </Modal>
  );
